    ...
    <>
      <div className={styles.page}>
        <div className={styles.header}>
          ...
          <Image
            src="https://avatars.githubusercontent.com/u/235658634?v=4"
            alt="SakaYq4875のアイコン"
            width={60}
            height={60}
          />
        ...
        <div className={styles.selfintroduction}>
          ...
          <div className={styles.hobbies}>
            ...
            <h2>数学</h2>
            <p>
              <Link href="https://www.onlinemathcontest.com">
                OnlineMathContest
              </Link>
              というサイトで様々な数学の問題を解いている
            </p>
          ...
          <div className={styles.goal}>
            <h1>目標</h1>
            <p>
              IT委員会フロントエンド長として、UI、UXなどについて気にしながら、すべての人にとって使いやすい創作展のホームページを作成したいです。
            </p>
            <p>
              また、プログラミングができる人を増やし、楽しいIT委員会を作っていきたいです。
            </p>
          </div>
        </div>
        ...
        <div className={styles.links}>
          <IconCard
            ...
            label="Github"
            href="https://www.github.com/SakaYq4875"
            size={70}
          />
          <IconCard
            icon="https://onlinemathcontest.com/assets/images/logo/OnlineMathContestLogo.JPG"
            label="OnlineMathContest"
            href="https://onlinemathcontest.com/users/SakaYq4875"
            size={70}
          />
          <IconCard
            icon="https://img.atcoder.jp/assets/top/img/logo_bk.svg"
            label="Atcoder"
            href="https://atcoder.jp/user/SakaYq4875"
            size={70}
          />
          <IconCard
            icon="https://www.kaggle.com/static/images/favicon.ico"
            label="kaggle"
            href="https://www.kaggle.com/SakaYq4875"
            size={70}
          />
        </div>
