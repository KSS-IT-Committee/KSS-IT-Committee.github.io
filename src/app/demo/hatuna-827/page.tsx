  ...
  return (
    <div className={styles.page}>
      <div className={styles.sidebarContainer}>
        <div className={styles.minititle}>K I T e C</div>
        <div className={styles.sidebarWrapper}>
          <div className={styles.sidebarContent}>
            <div className={styles.bannerText}>☆★ 相互リンク募集中 ★☆</div>
            <Image
      ...
      <div className={styles.top} style={{ display: isActive ? 'none' : 'block' }}>
        <div className={styles.title}>hatuna-827's demo site</div>
        ...
        <br />
        <div className={styles.ENTER}><span onClick={() => setIsActive(true)}>E</span><span>N</span><span title='左のEからお入りください。'>T</span><span>E</span><span>R</span></div>
      </div>
