      ...
      <div className={styles.background}>
        ...
        <main className={zenMaruGothic.className}>
          <div className={styles.icon_and_profile}>
            <Image
              src="https://github.com/kinoto0103.png"
              alt="Profile picture of kinoto0103"
            ...
            <section className={styles.profile}>
              ...
              <div className={styles.profile_items}>
                ...
                <article>
                  <h3>部活</h3>
                  <p>軽音楽研究会、物理研究会ロボット班</p>
                </article>
                <article>
                  <h3>委員会</h3>
                  <p>IT、対面式、立志、ゲート、新聞</p>
                </article>
                <article>
                  <h3>趣味</h3>
                  <p>ピアノ、DTM、イラスト</p>
                ...
                <article>
                  <h3>勉強したことがあるもの</h3>
                  <p>Python, C++, HTML, CSS, JavaScript, Reactなど</p>
                </article>
              </div>
            </section>
          </div>
          <div className={styles.introduction}>
            ...
            <p>
              いつか作曲してMVを作ったりゲームを作ったりしてみたいなと思いながら生活しています。
            </p>
            <p>
              小1から小6までロボットプログラミング教室に通っていましたが、PythonやHTMLなどの勉強を始めたのは中学に入ってからです。
            </p>
            <p>
              プログラミングはまだまだ初心者ですが頑張ります。よろしくお願いします！
            </p>
          </div>
          <div className={styles.accounts}>
            <a
              href="https://github.com/kinoto0103"
              target="_blank"
